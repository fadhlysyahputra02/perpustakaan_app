...
import 'jenis_buku_form_screen.dart';

class JenisBukuListScreen extends StatefulWidget {
  const JenisBukuListScreen({super.key});

  @override
  State<JenisBukuListScreen> createState() => _JenisBukuListScreenState();
}

class _JenisBukuListScreenState extends State<JenisBukuListScreen> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<JenisBukuProvider>().fetchAll();
    });
  }

  void _goToForm({JenisBuku? item}) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => JenisBukuFormScreen(jenisBuku: item),
      ),
    );
  }
...
class _JenisBukuCard extends StatelessWidget {
  final JenisBuku item;
  final VoidCallback onEdit;
  final VoidCallback onDelete;

  const _JenisBukuCard({
    required this.item,
